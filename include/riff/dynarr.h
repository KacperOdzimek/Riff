...
void FUNC_IMPL(dynarr_destroy, SU)(NAME* tar) {
    ...
    #define dynarr_destroy(LSU) FUNC_IMPL(dynarr_destroy, LSU)
#endif
...
int FUNC_IMPL(dynarr_reserve, SU)(NAME* arr, size_t capacity) {
    ...
    #define dynarr_reserve(LSU) FUNC_IMPL(dynarr_reserve, LSU)
#endif
...
int FUNC_IMPL(dynarr_shrink_to_fit, SU)(NAME* arr) {
    ...
    #define dynarr_shrink_to_fit(LSU) FUNC_IMPL(dynarr_shrink_to_fit, LSU)
#endif
...
size_t FUNC_IMPL(dynarr_size, SU)(NAME* arr) {
    return arr->priv_size;
}

#ifndef dynarr_size
    // Returns count of elements in the dynamic array
    #define dynarr_size(LSU) FUNC_IMPL(dynarr_size, LSU)
#endif

size_t FUNC_IMPL(dynarr_capacity, SU)(NAME* arr) {
    return arr->priv_capc;
}

#ifndef dynarr_capacity
    // Proper way of obtaining count of elements in dynamic array
    #define dynarr_capacity(LSU) FUNC_IMPL(dynarr_capacity, LSU)
#endif
...
T1* FUNC_IMPL(dynarr_access, SU)(NAME* arr) {
    ...
    // O(1)
    #define dynarr_access(LSU) FUNC_IMPL(dynarr_access, LSU)
#endif

const T1* FUNC_IMPL(dynarr_const_access, SU)(const NAME* arr) {
    ...
    // Only the first dynarr_size() amount of elements are initialized and valid
    // O(1)
    #define dynarr_const_access(LSU) FUNC_IMPL(dynarr_const_access, LSU)
#endif
...
int FUNC_IMPL(dynarr_push, SU)(NAME* arr, T1 value) {
    ...
    #define dynarr_push(LSU) FUNC_IMPL(dynarr_push, LSU)
#endif

int FUNC_IMPL(dynarr_pop, SU)(NAME* arr, T1* out) {
    ...
    #define dynarr_pop(LSU) FUNC_IMPL(dynarr_pop, LSU)
#endif

int FUNC_IMPL(dynarr_pop_many, SU)(NAME* arr, T1* out, size_t amount) {
    ...
    #define dynarr_pop_many(LSU) FUNC_IMPL(dynarr_pop_many, LSU)
#endif

void FUNC_IMPL(dynarr_clear, SU)(NAME* arr) {
    ...
    #define dynarr_clear(LSU) FUNC_IMPL(dynarr_clear, LSU)
#endif
